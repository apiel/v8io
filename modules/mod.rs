...
pub struct Modules {
    module_map: HashMap<i32, ModuleItem>,
}
...
impl Modules {
    ...
    fn insert(&mut self, module: v8::Local<v8::Module>, absolute_path: String) {
        let module_item = ModuleItem { absolute_path };
        self.module_map
            .insert(module.get_identity_hash(), module_item);
    }
    ...
    pub fn resolver<'a>(
        ...
        let module = self.compile(scope, "module.js", specifier).unwrap();
    ...
    pub fn compile_file<'sc>(
        ...
        let module = self.compile(scope, file, source_string);
        self.insert(module.clone().unwrap(), file.to_string());
    ...
    fn compile<'sc>(
        ...
        let origin = self.script_origin(scope, file);
